...
import {
  ICommand, IHook, IPaths, IPlugin, IPreset,
} from './utils/types';
import {
  IS_ADD_HOOK, IS_EVENT_HOOK, IS_MODIFY_HOOK, PluginType,
} from './utils/constants';
import {
  convertPluginsToObject, mergePlugins, printHelpLog, resolvePresetsOrPlugins,
} from './utils';
